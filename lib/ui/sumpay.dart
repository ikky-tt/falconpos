...
print(res.data[0]['docdate']);
      setState(() {
        ...
        _shipping = res.data[0]['shippingamount'];
  ...
  Future<void> PrintEng(
   ...
   // printer.textEncoded(convertStringToUint8List('สวัสดี'),styles: PosStyles(codeTable: 'CP874'));
    ...
    printer.feed(1);
    _texttran.text != ''?printer.row([
      PosColumn(
          text: ' Shipping rate',
          width: 6 ,
          styles: PosStyles(align: PosAlign.left, width: PosTextSize.size1)),
      PosColumn(
          text: oCcy2.format(num.parse(_texttran.text)),
          width: 5,
          styles: PosStyles(align: PosAlign.right, width: PosTextSize.size1 ,codeTable: "CP437" )),
      PosColumn(
          text: '',
                      ...
                      ElevatedButton(
                          onPressed: () async {
                            await ApiSerivces().UpdatePayment(_id, _paynumshow, _payme).then((e) {
                                ...
                                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>MainPOS()));
                            ...
                            child: InkWell(
                              ...
                              child: Container(
                                ...
                                child:  Row(
                                  children: <Widget>[
                                    Padding(
                                      padding: const EdgeInsets.fromLTRB(5.0,8,2,8),
                                      child: Stack(
                                        alignment: Alignment.center,
                                        children:  [
                                          SizedBox(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Expanded(child:  NumberButton(1, 40, _pay),),
                                  const SizedBox(
                                    width: 10,
                                  ),
                                  Expanded(child:  NumberButton(2, 40, _pay),),
                                  const SizedBox(
                                    width: 10,
                                  ),
                                  Expanded(child:  NumberButton(3, 40, _pay),)
                                ],
                              ),
                              SizedBox(
                                height: 10,
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Expanded(child:  NumberButton(4, 40, _pay),),
                                  const SizedBox(
                                    width: 10,
                                  ),
                                  Expanded(child:  NumberButton(5, 40, _pay),),
                                  const SizedBox(
                                    width: 10,
                                  ),
                                  Expanded(child:  NumberButton(6, 40, _pay),)
                                ],
                              ),
                              SizedBox(
                                height: 10,
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Expanded(child:  NumberButton(7, 40, _pay),),
                                  const SizedBox(
                                    width: 10,
                                  ),
                                  Expanded(child:  NumberButton(8, 40, _pay),),
                                  const SizedBox(
                                    width: 10,
                                  ),
                                  Expanded(child:  NumberButton(9, 40, _pay),)
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Expanded(child:  NumberButton(0, 40, _pay),),
                                  const SizedBox(
                                    width: 10,
                                  ),
                      ...
                      ElevatedButton(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(' Shipping Rate',style: textBody.copyWith(color:Colors.white),)
                            ],
                          ),
                        style: ElevatedButton.styleFrom(
                                ...
                                _texttran.text != ''?Row(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      Alignment.centerRight,
                                      child: Text(
                                        "  ${_texttran.text != '' ? oCcy.format(num.parse(_texttran.text)).toString() : "0.00"}",
                                        style: textBody.copyWith(
                                          fontSize: 18,
                                        ),
                                      ),
                                ...
                                ElevatedButton(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        Icon(LineIcons.truckMoving,color: Colors.white,),
                                        Text(' Shipping Rate', style: textBodyLage.copyWith(fontSize: 18),)
                                      ],
                                    ),
                                  ),
                                  style: ElevatedButton.styleFrom(
  ...
  Future<List<int>> _customEscPos() async {
    ...
    bytes += printer.text('Receipt',styles: PosStyles(align: PosAlign.center));
    ...
    bytes += printer.feed(1);
    bytes += printer.text('------------------------------------------------------', styles: PosStyles(align: PosAlign.center));
    bytes += printer.feed(1);
    bytes +=  printer.row([
      PosColumn(text: 'Qty', width: 1),
      PosColumn(text: 'Item', width: 8,styles: PosStyles(align: PosAlign.center)),
    ...
    bytes += printer.text('------------------------------------------------------', styles: PosStyles(align: PosAlign.center));
    bytes += printer.feed(1);
    bytes += printer.text('Items : ${_count}');
    bytes += printer.feed(1);
    bytes +=  printer.text('------------------------------------------------------', styles: PosStyles(align: PosAlign.center));
    bytes += printer.feed(1);
    bytes += printer.feed(1);
    ...
    _dicount!=0? bytes += printer.feed(1):null;
    bytes +=  printer.row([
      PosColumn(
          text: 'BeforeVat',
          width: 6,
    ...
    bytes += printer.feed(2);
    bytes += printer.text(_line1show,
        styles: PosStyles(align: PosAlign.center, bold: true),linesAfter: 2);
    bytes += printer.text(_line2show,
        styles: PosStyles(align: PosAlign.center, bold: true),linesAfter: 2);
    printer.text(_line3show!,
        styles: PosStyles(align: PosAlign.center, bold: true),linesAfter: 2);
    ...
    bytes += printer.drawer(pin: PosDrawer.pin2);
