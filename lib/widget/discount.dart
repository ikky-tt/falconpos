...
class Discount extends StatefulWidget {
  ...
  const Discount({Key? key, required this.controller, required this.onSubmit, required this.discountstatus, required this.buttonSize, required this.buttonColor}) : super(key: key);
