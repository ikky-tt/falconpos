...
class EditDateDate extends StatefulWidget {
...
class _EditDateDateState extends State<EditDateDate> {
      ...
      children: [
        ...
        DropdownSearch<SalechanelModel>(
          ...
          popupProps: PopupPropsMultiSelection.modalBottomSheet(
            ...
            showSearchBox:false,
            itemBuilder: (BuildContext context, SalechanelModel item, bool isSelected) {
              return Container(
                ...
                child: ListTile(
                  selected: isSelected,
                  title: Text(item.name,style: textBodyLage.copyWith(fontSize: 14,color: Colors.black),),
                ),
              );
            },
